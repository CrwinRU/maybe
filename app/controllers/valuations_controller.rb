  ...
  def create
    ...
    if result.success?
      respond_to do |format|
        format.html { redirect_back_or_to account_path(account), notice: t(".updated") }
        format.turbo_stream { stream_redirect_back_or_to(account_path(account), notice: t(".updated")) }
      end
    else
