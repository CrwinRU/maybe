module Accountable
  ...
  TYPES = %w[Depository Investment Crypto Property Vehicle OtherAsset CreditCard Loan OtherLiability Cash]
  ...
  class_methods do
    ...
    def display_name
      I18n.t("accountable.#{self.name.underscore}.display_name", default: self.name.pluralize.titleize)
    end
